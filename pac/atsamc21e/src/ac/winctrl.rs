...
pub type Wen1R = crate::BitReader;
#[doc = "Field `WEN1` writer - Window 1 Mode Enable"]
pub type Wen1W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Window 1 Interrupt Selection\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Wintsel1select {
    #[doc = "0: Interrupt on signal above window"]
    Above = 0,
    #[doc = "1: Interrupt on signal inside window"]
    Inside = 1,
...
impl From<Wintsel1select> for u8 {
    #[inline(always)]
    fn from(variant: Wintsel1select) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for Wintsel1select {
    type Ux = u8;
}
impl crate::IsEnum for Wintsel1select {}
#[doc = "Field `WINTSEL1` reader - Window 1 Interrupt Selection"]
pub type Wintsel1R = crate::FieldReader<Wintsel1select>;
impl Wintsel1R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Wintsel1select {
        match self.bits {
            0 => Wintsel1select::Above,
            1 => Wintsel1select::Inside,
            2 => Wintsel1select::Below,
            3 => Wintsel1select::Outside,
            _ => unreachable!(),
        }
    }
    #[doc = "Interrupt on signal above window"]
    #[inline(always)]
    pub fn is_above(&self) -> bool {
        *self == Wintsel1select::Above
    }
    #[doc = "Interrupt on signal inside window"]
    #[inline(always)]
    pub fn is_inside(&self) -> bool {
        *self == Wintsel1select::Inside
    }
    #[doc = "Interrupt on signal below window"]
    #[inline(always)]
    pub fn is_below(&self) -> bool {
        *self == Wintsel1select::Below
    }
    #[doc = "Interrupt on signal outside window"]
    #[inline(always)]
    pub fn is_outside(&self) -> bool {
        *self == Wintsel1select::Outside
    }
}
#[doc = "Field `WINTSEL1` writer - Window 1 Interrupt Selection"]
pub type Wintsel1W<'a, REG> = crate::FieldWriter<'a, REG, 2, Wintsel1select, crate::Safe>;
impl<'a, REG> Wintsel1W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    ...
    #[inline(always)]
    pub fn above(self) -> &'a mut crate::W<REG> {
        self.variant(Wintsel1select::Above)
    }
    #[doc = "Interrupt on signal inside window"]
    #[inline(always)]
    pub fn inside(self) -> &'a mut crate::W<REG> {
        self.variant(Wintsel1select::Inside)
    }
    #[doc = "Interrupt on signal below window"]
    #[inline(always)]
    pub fn below(self) -> &'a mut crate::W<REG> {
        self.variant(Wintsel1select::Below)
    }
    #[doc = "Interrupt on signal outside window"]
    #[inline(always)]
    pub fn outside(self) -> &'a mut crate::W<REG> {
        self.variant(Wintsel1select::Outside)
    }
}
impl R {
    ...
    #[inline(always)]
    pub fn wen1(&self) -> Wen1R {
        Wen1R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bits 5:6 - Window 1 Interrupt Selection"]
    #[inline(always)]
    pub fn wintsel1(&self) -> Wintsel1R {
        Wintsel1R::new((self.bits >> 5) & 3)
    }
}
impl W {
    #[doc = "Bit 0 - Window 0 Mode Enable"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn wen1(&mut self) -> Wen1W<WinctrlSpec> {
        Wen1W::new(self, 4)
    }
    #[doc = "Bits 5:6 - Window 1 Interrupt Selection"]
    #[inline(always)]
    #[must_use]
    pub fn wintsel1(&mut self) -> Wintsel1W<WinctrlSpec> {
        Wintsel1W::new(self, 5)
    }
}
