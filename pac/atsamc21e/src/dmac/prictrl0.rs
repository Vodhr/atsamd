...
impl From<Rrlvlen0select> for bool {
    #[inline(always)]
    fn from(variant: Rrlvlen0select) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `RRLVLEN0` reader - Level 0 Round-Robin Scheduling Enable"]
pub type Rrlvlen0R = crate::BitReader<Rrlvlen0select>;
impl Rrlvlen0R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Rrlvlen0select {
        match self.bits {
            false => Rrlvlen0select::StaticLvl,
            true => Rrlvlen0select::RoundRobinLvl,
        }
    }
    #[doc = "Static arbitration scheme for channels with level 3 priority"]
    #[inline(always)]
    pub fn is_static_lvl(&self) -> bool {
        *self == Rrlvlen0select::StaticLvl
    }
    #[doc = "Round-robin arbitration scheme for channels with level 3 priority"]
    #[inline(always)]
    pub fn is_round_robin_lvl(&self) -> bool {
        *self == Rrlvlen0select::RoundRobinLvl
    }
}
#[doc = "Field `RRLVLEN0` writer - Level 0 Round-Robin Scheduling Enable"]
pub type Rrlvlen0W<'a, REG> = crate::BitWriter<'a, REG, Rrlvlen0select>;
impl<'a, REG> Rrlvlen0W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Static arbitration scheme for channels with level 3 priority"]
    #[inline(always)]
    pub fn static_lvl(self) -> &'a mut crate::W<REG> {
        self.variant(Rrlvlen0select::StaticLvl)
    }
    #[doc = "Round-robin arbitration scheme for channels with level 3 priority"]
    #[inline(always)]
    pub fn round_robin_lvl(self) -> &'a mut crate::W<REG> {
        self.variant(Rrlvlen0select::RoundRobinLvl)
    }
}
