...
impl TrigsrcR {
    ...
    pub const fn variant(&self) -> Option<Trigsrcselect> {
        match self.bits {
            ...
            14 => Some(Trigsrcselect::Can0Debug),
            15 => Some(Trigsrcselect::Can1Debug),
            ...
            43 => Some(Trigsrcselect::Adc1Resrdy),
            44 => Some(Trigsrcselect::SdadcResrdy),
            45 => Some(Trigsrcselect::DacEmpty),
    ...
    pub fn is_sdadc_resrdy(&self) -> bool {
        *self == Trigsrcselect::SdadcResrdy
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn tsens(self) -> &'a mut crate::W<REG> {
        self.variant(Trigsrcselect::Tsens)
    }
    #[doc = "SERCOM0 RX Trigger"]
    #[inline(always)]
    ...
    #[doc = "SDADC Result Ready Trigger"]
    #[inline(always)]
    pub fn sdadc_resrdy(self) -> &'a mut crate::W<REG> {
        self.variant(Trigsrcselect::SdadcResrdy)
    }
    #[doc = "DAC Empty Trigger"]
    #[inline(always)]
