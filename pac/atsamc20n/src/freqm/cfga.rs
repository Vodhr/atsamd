...
pub type DivrefR = crate::BitReader;
#[doc = "Field `DIVREF` writer - Divide Reference Clock"]
pub type DivrefW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn divref(&self) -> DivrefR {
        DivrefR::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:7 - Number of Reference Clock Cycles"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn divref(&mut self) -> DivrefW<CfgaSpec> {
        DivrefW::new(self, 15)
    }
}
