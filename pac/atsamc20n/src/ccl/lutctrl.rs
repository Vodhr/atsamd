...
impl Insel0R {
    ...
    pub const fn variant(&self) -> Option<Insel0select> {
        match self.bits {
            ...
            10 => Some(Insel0select::Alt2tc),
            11 => Some(Insel0select::Asyncevent),
            _ => None,
        }
    }
    #[doc = "Masked input"]
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "Alternate 2 TC input source"]
    #[inline(always)]
    pub fn alt2tc(self) -> &'a mut crate::W<REG> {
        self.variant(Insel0select::Alt2tc)
    }
    #[doc = "ASYNC EVENT input source. The EVENT input will bypass edge detection logic."]
    #[inline(always)]
    pub fn asyncevent(self) -> &'a mut crate::W<REG> {
        self.variant(Insel0select::Asyncevent)
    }
}
