...
pub type R = crate::R<BodvddSpec>;
#[doc = "Register `BODVDD` writer"]
pub type W = crate::W<BodvddSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> EnableW<BodvddSpec> {
        EnableW::new(self, 1)
    }
    #[doc = "Bit 2 - Hysteresis Enable"]
    #[inline(always)]
    #[must_use]
    pub fn hyst(&mut self) -> HystW<BodvddSpec> {
        HystW::new(self, 2)
    }
    #[doc = "Bits 3:4 - Action when Threshold Crossed"]
    #[inline(always)]
    #[must_use]
    pub fn action(&mut self) -> ActionW<BodvddSpec> {
        ActionW::new(self, 3)
    }
    #[doc = "Bit 5 - Configuration in Standby mode"]
    #[inline(always)]
    #[must_use]
    pub fn stdbycfg(&mut self) -> StdbycfgW<BodvddSpec> {
        StdbycfgW::new(self, 5)
    }
    #[doc = "Bit 6 - Run during Standby"]
    #[inline(always)]
    #[must_use]
    pub fn runstdby(&mut self) -> RunstdbyW<BodvddSpec> {
        RunstdbyW::new(self, 6)
    }
    #[doc = "Bit 8 - Configuration in Active mode"]
    #[inline(always)]
    #[must_use]
    pub fn actcfg(&mut self) -> ActcfgW<BodvddSpec> {
        ActcfgW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Prescaler Select"]
    #[inline(always)]
    #[must_use]
    pub fn psel(&mut self) -> PselW<BodvddSpec> {
        PselW::new(self, 12)
    }
    #[doc = "Bits 16:21 - Threshold Level for VDD"]
    #[inline(always)]
    #[must_use]
    pub fn level(&mut self) -> LevelW<BodvddSpec> {
        LevelW::new(self, 16)
    }
}
#[doc = "BODVDD Control\n\nYou can [`read`](crate::Reg::read) this register and get [`bodvdd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bodvdd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct BodvddSpec;
impl crate::RegisterSpec for BodvddSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`bodvdd::R`](R) reader structure"]
impl crate::Readable for BodvddSpec {}
#[doc = "`write(|w| ..)` method takes [`bodvdd::W`](W) writer structure"]
impl crate::Writable for BodvddSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets BODVDD to value 0"]
impl crate::Resettable for BodvddSpec {
