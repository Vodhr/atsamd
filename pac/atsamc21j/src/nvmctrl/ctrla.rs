...
impl CmdR {
    ...
    pub const fn variant(&self) -> Option<Cmdselect> {
        match self.bits {
            ...
            26 => Some(Cmdselect::Rwweeer),
            28 => Some(Cmdselect::Rwweewp),
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "RWW EEPROM area Erase Row - Erases the row addressed by the ADDR register."]
    #[inline(always)]
    pub fn rwweeer(self) -> &'a mut crate::W<REG> {
        self.variant(Cmdselect::Rwweeer)
    }
    #[doc = "RWW EEPROM Write Page - Writes the contents of the page buffer to the page addressed by the ADDR register."]
    #[inline(always)]
    pub fn rwweewp(self) -> &'a mut crate::W<REG> {
        self.variant(Cmdselect::Rwweewp)
    }
    #[doc = "Lock Region - Locks the region containing the address location in the ADDR register."]
    #[inline(always)]
