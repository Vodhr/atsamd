...
impl StartupR {
    ...
    pub const fn variant(&self) -> Startupselect {
        match self.bits {
            ...
            1 => Startupselect::Cycle32,
            2 => Startupselect::Cycle2048,
            3 => Startupselect::Cycle4096,
            4 => Startupselect::Cycle16384,
            5 => Startupselect::Cycle32768,
            6 => Startupselect::Cycle65536,
            7 => Startupselect::Cycle131072,
            _ => unreachable!(),
        }
    }
    #[doc = "0.122 ms"]
