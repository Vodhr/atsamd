...
impl RefclkR {
    ...
    pub const fn variant(&self) -> Option<Refclkselect> {
        match self.bits {
            0 => Some(Refclkselect::Xosc32k),
            1 => Some(Refclkselect::Xosc),
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn xosc32k(self) -> &'a mut crate::W<REG> {
        self.variant(Refclkselect::Xosc32k)
    }
    #[doc = "XOSC clock reference"]
    #[inline(always)]
    pub fn xosc(self) -> &'a mut crate::W<REG> {
        self.variant(Refclkselect::Xosc)
    }
    #[doc = "GCLK clock reference"]
    #[inline(always)]
