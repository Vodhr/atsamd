...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn bodcore(&self) -> &Bodcore {
        &self.bodcore
    }
...
#[doc = "BODVDD Control"]
pub mod bodvdd;
#[doc = "BODCORE (rw) register accessor: BODCORE Control\n\nYou can [`read`](crate::Reg::read) this register and get [`bodcore::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bodcore::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@bodcore`]
module"]
#[doc(alias = "BODCORE")]
pub type Bodcore = crate::Reg<bodcore::BodcoreSpec>;
#[doc = "BODCORE Control"]
pub mod bodcore;
